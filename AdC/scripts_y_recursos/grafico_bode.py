...
numerador = [0, -2127.66 ,0]  # Coeficientes del numerador
denominador = [1, 909.1, 6510255.24]  # Coeficientes del denominador
G = ctrl.TransferFunction(numerador, denominador)

# Calcular el diagrama de Bode (sin graficar automáticamentase)
frecuencia, ganancia, fase = ctrl.bode_plot(G,omega=[100,15000] , dB=True, Hz=False, deg=True, plot=True, freq_label = "Frecuencia [rad/s]", magnitude_label = "Magnitud [dB]", phase_label = "Fase [°]", title = "Diagrama de Bode")
