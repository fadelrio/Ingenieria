...
frecuencia, ganancia, fase = ctrl.bode_plot(G,omega=[100,150000] , dB=True, Hz=False, deg=True, plot=True, freq_label = "Frecuencia [rad/s]", magnitude_label = "Magnitud [dB]", phase_label = "Fase [°]", title = "Diagrama de Bode")
