...
numerador = [-12660, 0]  # Coeficientes del numerador (2,1,0)
denominador = [1, 974, 20660000]  # Coeficientes del denominador (2,1,0)
...
frecuencia, ganancia, fase = ctrl.bode_plot(G,omega=[10,100000] , dB=True, Hz=False, deg=True, plot=True, freq_label = "Frecuencia [rad/s]", magnitude_label = "Magnitud [dB]", phase_label = "Fase [°]", title = "Diagrama de Bode")
