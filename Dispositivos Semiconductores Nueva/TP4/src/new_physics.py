...
##D. B. M. Klaassen, J. W. Slotboom, and H. C. de Graaff, "Unified apparent bandgap narrowing in n- and p-type Silicon," Solid-State Electronics, vol. 35, no. 2, pp. 125-29, 1992.
    par = {
      ...
      'ALPHAEP' : -0.146,
      # SRH
      "taun" : 1e-7, # Originalmente 1e-5
      "taup" : 2e-7, # Originalmente 1e-5
      "n1" : 1e10,
      "p1" : 1e10,
      # TEMP
      "T" : 300
...
def CreateSRH(device, region, variables, enable_SRH=True):
    '''
...
def CreateSiliconDriftDiffusion(device, region, enable_SRH=True, mu_n="mu_n", mu_p="mu_p", Jn='Jn', Jp='Jp'):
    '''
    ...
    CreateSRH(device, region, ("Electrons", "Holes", "Potential"), enable_SRH=enable_SRH)
